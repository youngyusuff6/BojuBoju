@extends('layouts.app')
@section('title') Privacy and Policy @endsection

{{-- ADD CSS CODE HERE | OR LINK CSS HERE --}}
@section('styles')
    <link rel="stylesheet" href="{{url('vendor/css/privacy.css')}}">
@endsection
@section('content')
    ...
    <div class="text-body" >
        <h3 class="display-3 mb-5">
           ...
           <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
            website with regards to the information that they shared and/or collect in BojuBoju.
           ...
           <p>
            ...
            are asked to provide it, will be made clear to you at the point we ask you to provide
       ...
       <li> Communicate with you, either directly or through one of our partners,
          ...
          <li>
           ...
           <h1>Log Files</h1>
           <p>
            BojuBoju follows a standard procedure of using log files. These files log visitors
         ...
         <h1>  Cookies and Web Beacons
          </h1>
          <p> Like any other website, BojuBoju uses 'cookies'. These cookies are used to store
          ...
          <h1>
           ...
           <p> Some of advertisers on our site may use cookies and web beacons. Our
            advertising partners are listed below. Each of our advertising partners has their
            own Privacy Policy for their policies on user data. For easier access, we
         ...
         <h1>Advertising Partners Privacy Policies</h1>
          <p> You may consult this list to find the Privacy Policy for each of the advertising
            ...
            appear on BojuBoju, which are sent directly to users' browser. They automatically
            ...
            Note that BojuBoju has no access to or control over these cookies that are used by
           ...
           <p>BojuBoju's Privacy Policy does not apply to other advertisers or websites. Thus,
         ...
         <p>
          ...
          <p> BojuBoju does not knowingly collect any Personal Identifiable Information from
