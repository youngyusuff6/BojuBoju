...
@section('styles')
    <link rel="stylesheet" href="{{url('vendor/css/disclaimer.css')}}">
@endsection
@section('content')
        ...
        <h3 class="display-3 mb-5">
            Disclaimer for Bojuboju
             ...
             <p class="paragraph">
                ...
                risk. bojuboju will not be liable for any losses and/or damages in connection with
            ...
            links to other websites do not imply a recommendation for all the content found on
            these sites. Site owners and content may change without notice and may occur
