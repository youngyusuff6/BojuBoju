    ...
    <div class="row justify-content-center">
        <div class="col-md-8 login-body">
            <div class="card border-0  bg-transparent" >
                    <div class="text-center text-default"><h1>Change Email Address</h1></div>
                <div class="card-body border-0 bg-transparent login-form body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('showChangeUsernamePost') }}">
                        ...
                        <div class="row mb-3">
                            <label for="current_email" class="col-md-4 login-label col-form-label text-md-end">Current Email</label>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 login-label col-form-label text-md-end">New Email</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn login-button"> Change Email Address</button>
